 ...
 *
 * Content Spacing:
 * - Top padding: 64px (h-16) for fixed header
...
export default async function DashboardLayout({
  ...
  return (
    <div className="relative min-h-screen bg-background">
      {/* Fixed Header - Desktop navigation (64px height) */}
      <Header />

      {/* Main Content Area */}
      {/*
        Spacing:
        - pt-16: Top padding to account for 64px fixed header
      ...
      */}
      <main className="pt-16 pb-24 md:pb-8 px-4 md:px-8">
